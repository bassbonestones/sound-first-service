"""
Material Ingestion Service - scans MusicXML files, detects capabilities,
computes soft gate metrics, and syncs with materials.json.
"""
...
from .analyzer import analyze_material, format_soft_gates, detect_all_capabilities
...
class MaterialIngestionService:
    ...
    def analyze_material(
        ...
        return analyze_material(
            musicxml_path,
            self.musicxml_analyzer,
            self.detection_engine,
            self.soft_gate_calculator,
            tempo_bpm
        )
        ...
        for mat in materials:
            ...
            try:
                ...
                if "capabilities" in metrics:
                    mat["detected_capabilities"] = detect_all_capabilities(
                        content,
                        self.musicxml_analyzer,
                        self.detection_engine,
                    )
                ...
                if "soft_gates" in metrics:
                    ...
                    mat["soft_gates"] = format_soft_gates(soft_gates)
